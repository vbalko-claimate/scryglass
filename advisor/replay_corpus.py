    ...
    for match_id, gn, turn, phase, data_str in evals:
        ...
        entry = {
            "state": {
                ...
                "hand": [c.get("name", "") for c in context.get("my_hand", [])],
                "my_battlefield": [c.get("name", "") for c in context.get("my_battlefield", [])],
                "opp_battlefield": [c.get("name", "") for c in context.get("opp_battlefield", [])],
            },
